  ...
  return (
    <div className='w-full bg-white/80 backdrop-blur-lg rounded-2xl shadow-md border border-gray-200 px-5 py-4 flex items-center justify-between hover:shadow-xl hover:-translate-y-1 transition-all duration-300 gap-10'>
        ...
        <div className='flex items-center gap-6'>
            ...
            <button onClick={()=> deleteTodo(index)} className='w-10 h-10 rounded-full bg-red-100 text-red-600 hover:bg-red-600 hover:text-white transition-all duration-300 flex items-center justify-center'> <FaTrash/> </button>
        </div>
    </div>
  )
}
